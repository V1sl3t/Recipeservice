# Generated by Django 3.2.3 on 2024-07-03 11:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(check=models.Q(('amount__gte', 1)), name='amount__gte=1'),
        ),
        migrations.AddConstraint(
            model_name='recipe',
            constraint=models.CheckConstraint(check=models.Q(('cooking_time__gte', 1)), name='cooking_time__gte=1'),
        ),
        migrations.AddConstraint(
            model_name='favorite',
